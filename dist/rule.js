...
var Rule = function (_EventEmitter) {
  ...
  function Rule(options) {
    ...
    if (options && options.branch) {
      _this.setBranch(options.branch);
    }
  ...
  _createClass(Rule, [{
    ...
    */
    ...
    key: 'setBranch',
    value: function setBranch(conditions) {
      if (!Object.prototype.hasOwnProperty.call(conditions, "all") && !Object.prototype.hasOwnProperty.call(conditions, "any")) {
        throw new Error('"Branch" root must contain a single instance of "all" or "any"');
      }
      this.branch = new _condition2.default(conditions);
      return this;
    }
    ...
    value: function evaluate(almanac) {
      ...
      var ruleResult = new _ruleResult2.default(this.conditions, this.ruleEvent, this.priority, this.name, this.branch);
      ...
      var branch = function branch(_branch) {
        return (_branch.any ? any(_branch.any) : all(_branch.all)).then(function (result) {
          return processBranchResult(result);
        });
      };

      var processBranchResult = function processBranchResult(result) {
